    ...
    return (
        <Tabs className="tab tab-nav-simple product-tabs" selectedTabClassName="show" selectedTabPanelClassName="active" defaultIndex={ 0 } >
            <TabList className="nav nav-tabs justify-content-center" role="tablist">
                ...
                {
                    product && product.data.brands.length > 0 || colors.length > 0 || sizes.length > 0 ?
                        <Tab className="nav-item">
                ...
                <Tab className="nav-item">
                    <span className="nav-link">Reviews ({ product.data.reviews })</span>
                </Tab>
            </TabList>
                    ...
                    <div className="row mt-6">
                        ...
                        <div className="col-md-6 pl-md-6 pt-4 pt-md-0">
                            ...
                            <figure className="p-relative d-inline-block mb-2">
                                <img src="./images/product.data.jpg" width="559" height="370"
                                    alt="Product" />
                    ...
                    product && product.data.brands.length > 0 || colors.length > 0 || sizes.length > 0 ?
                        <TabPanel className="tab-pane product-tab-additional">
                            <ul className="list-none">
                                ...
                                {
                                    product.data.brands.length > 0 ?
                                        <li><label>Brands:</label>
                                            <p>
                                                { product.data.brands.map( ( item, index ) => (
                                                    <React.Fragment key={ item.name + '-' + index }>
                                                        { item.name }
                                                        { index < product.data.brands.length - 1 ? ', ' : "" }
                                                    </React.Fragment>
                                                ) ) }
                                            </p>
                                        </li> : ""
                                            ...
                                            <div className="comment-body">
                                                <div className="comment-rating ratings-container mb-0">
                                                    <div className="ratings-full">
                                                        <span className="ratings" style={ { width: product.data.ratings * 20 + '%' } }></span>
                    ...
                    <div className="reply">
                        <div className="title-wrapper text-left">
                            <h3 className="title title-simple text-left text-normal">
                                {
                                    product.data.reviews > 0 ? "Add a Review" :
...
export default connect( '', { openModal: modalActions.openModal } )( decsOne )
