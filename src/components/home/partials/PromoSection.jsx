...
import { fadeIn ,fadeInUpShorter } from '../../../basePathLocation/data/keyframes';
export default function PromoSection() {
    return (
        <Reveal keyframes={ fadeIn } triggerOnce>
            <section className="banner banner-sale mt-10 mb-10"
                style={ { backgroundImage: `url(https://d-themes.com/wordpress/riode/demo-2/wp-content/uploads/sites/6/2021/01/3-1.jpg)`, backgroundColor: "#1f272b" } }>
