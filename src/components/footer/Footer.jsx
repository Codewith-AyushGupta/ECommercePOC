...
import logo from '..//header/images/logo-footer.png'
                ...
                <div className="row align-items-center">
                    <div className="col-lg-3">
                        <ALink href="/" className="logo-footer">
                            <img src={logo} alt="logo-footer" width="154" height="43" />
                        </ALink>
                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="widget widget-instagram">
                            ...
                            <figure className="widget-body row">
                                <div className="col-3">
                                    <img src={img1} alt="instagram 1" width="64" height="64" />
                                </div>
                                <div className="col-3">
                                    <img src={img1} alt="instagram 2" width="64" height="64" />
                                </div>
                                <div className="col-3">
                                    <img src={img1} alt="instagram 3" width="64" height="64" />
                                </div>
                                <div className="col-3">
                                    <img src={img1} alt="instagram 4" width="64" height="64" />
                                </div>
                                <div className="col-3">
                                    <img src={img1} alt="instagram 5" width="64" height="64" />
                                </div>
                                <div className="col-3">
                                    <img src={img1} alt="instagram 6" width="64" height="64" />
                                </div>
                                <div className="col-3">
                                    <img src={img1} alt="instagram 7" width="64" height="64" />
                                </div>
                                <div className="col-3">
                                    <img src={img1} alt="instagram 8" width="64" height="64" />
                                </div>
                            </figure>
                        </div>
                    </div>
