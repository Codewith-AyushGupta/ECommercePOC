                                                    ...
                                                    <OwlCarousel adClass="owl-theme owl-dot-inner owl-dot-white gutter-no" options={ mainSlider20 }>
                                                        {
                                                                ...
                                                                <img
                                                                    src={post[0].picture.url }
                                                                    alt="post gallery"
                                                                    key={ post[0].picture.title + '-' + 'index' }
                                                                    width={ post[0].picture.width }
                                                                    height={ post[0].picture.height }
                                                                    style={ { backgroundColor: "#DEE6E8" } }
                                                                />
                                                            }
                                                    </OwlCarousel>
                                        ...
                                        <div className="post-details">
                                            ...
                                            <div className="post-body mb-7">
                                                ...
                                                <div className="with-img row align-items-center">
                                                    <div className="col-md-6 mb-6">
                                                        <figure>
                                                            <LazyLoadImage
                                                                src="https://d-themes.com/wordpress/riode/elements/wp-content/uploads/sites/3/2020/09/1.jpg"
                                            ...
                                            <div className="post-author-detail">
                                                <figure className="author-media">
                                                    <ALink href="#">
                                                        <img src="https://secure.gravatar.com/avatar/7a2bb5e1cdc8a5ac3bb113771b6a8b50?s=80&d=mm&r=g" alt="avatar" width="50" height="50" />
                                                    </ALink>
                                                </figure>
